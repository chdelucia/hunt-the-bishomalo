...
<<<<<<< HEAD:src/app/components/controls/game-controls.component.spec.ts
import { GameEngineService, ACHIEVEMENT_SERVICE } from '@hunt-the-bishomalo/core/services';
import { getTranslocoTestingModule } from '@hunt-the-bishomalo/core/utils';
import { provideRouter, Router } from '@angular/router';
=======
import { GameEngineService, ACHIEVEMENT_SERVICE } from '@hunt-the-bishomalo/game/data-access';
import { getTranslocoTestingModule } from '@hunt-the-bishomalo/core';
import { provideRouter } from '@angular/router';
>>>>>>> df75268 (chore: temporary commit to allow merge):libs/game/ui/src/lib/controls/game-controls.component.spec.ts

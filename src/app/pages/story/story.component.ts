...
export class StoryComponent implements OnInit, OnDestroy {
  ...
  formatEffect(effect: string): string {
    // Reuse existing diary.effect.* keys
  ...
  private startReading(text: string): void {
    ...
    const titleText = this.story?.title ?? ''; // Title will be translated at source
    const bodyText = text; // Text will be translated at source
